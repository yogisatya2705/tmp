				...
				return e = t, (n = [{
					...
					value: function (t, e) {
						...
						return (n = t, i.a.Deferred((function (t) {
							...
							o.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", "100%")), t.show(), o.getLastRange().insertNode(t[0]), o.setLastRange(wt.createFromNodeAfter(t[0]).select()), o.afterCommand()
						})).fail((function (t) {
				...
				return e = t, (n = [{
					...
					value: function (t) {
						...
						if (n && 11 === n[1].length) {
							...
							e = i()("<iframe>").attr("frameborder", 0).attr("src", "//www.youtube.com/embed/" + m + (v > 0 ? "?start=" + v : "")).attr("width", "640").attr("height", "360").attr('allowFullScreen', '')
